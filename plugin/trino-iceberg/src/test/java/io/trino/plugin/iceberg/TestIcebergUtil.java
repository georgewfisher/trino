...
public class TestIcebergUtil
{
    ...
    public void testParseVersion()
    {
        ...
        assertEquals(parseVersion("hdfs://hadoop-master:9000/user/hive/warehouse/orders_5-581fad8517934af6be1857a903559d44/metadata/v0.metadata.json"), OptionalInt.of(0));
        assertEquals(parseVersion("hdfs://hadoop-master:9000/user/hive/warehouse/orders_5-581fad8517934af6be1857a903559d44/metadata/v99999.metadata.json"), OptionalInt.of(99999));
        assertEquals(parseVersion("s3://krvikash-test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/v10.metadata.json"), OptionalInt.of(10));
        assertEquals(parseVersion("/var/test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/v11.metadata.json"), OptionalInt.of(11));
        ...
        assertThatThrownBy(() -> parseVersion("hdfs://hadoop-master:9000/user/hive/warehouse/orders_5-581fad8517934af6be1857a903559d44/metadata/00003_409702ba-4735-4645-8f14-09537cc0b2c8.metadata.json"))
                .hasMessageMatching(".*Invalid metadata location:.*");
        assertThatThrownBy(() -> parseVersion("/var/test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/-00010-409702ba-4735-4645-8f14-09537cc0b2c8.metadata.json"))
                .hasMessageMatching(".*Invalid metadata location:.*");

        // verify incomplete transaction files are ignored
        assertEquals(parseVersion("hdfs://hadoop-master:9000/user/hive/warehouse/orders_5-581fad8517934af6be1857a903559d44/metadata/409702ba-4735-4645-8f14-09537cc0b2c8.metadata.json"), OptionalInt.empty());
        assertEquals(parseVersion("/var/test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/40970211-4735-4645-8f14-09537cc0b2c8.metadata.json"), OptionalInt.empty());
    }
}
